                        ...
                        <div class="dropdown-header px-0 text-wrap header-notification-scroll position-relative"
                            ...
                            <div class="list-group list-group-flush w-100">
                                <a class="list-group-item list-group-item-action">
                                    <div class="d-flex">
                                        <div class="flex-shrink-0">
                                            <img src="<?php echo _WEB_ROOT; ?>/public/assets/admin/images/user/avatar-2.jpg"
                                ...
                                <a class="list-group-item list-group-item-action">
                                    <div class="d-flex">
                                        <div class="flex-shrink-0">
                                            <img src="<?php echo _WEB_ROOT; ?>/public/assets/admin/images/user/avatar-1.jpg"
                                                alt="user-image" class="user-avtar">
                                        </div>
                                        <div class="flex-grow-1 ms-1">
                                ...
                                <a class="list-group-item list-group-item-action">
                                    <div class="d-flex">
                                        <div class="flex-shrink-0">
                                            <img src="<?php echo _WEB_ROOT; ?>/public/assets/admin/images/user/avatar-3.jpg"
                                                alt="user-image" class="user-avtar">
                                        </div>
                                        <div class="flex-grow-1 ms-1">
                                ...
                                <a class="list-group-item list-group-item-action">
                                    <div class="d-flex">
                                        <div class="flex-shrink-0">
                                            <img src="<?php echo _WEB_ROOT; ?>/public/assets/admin/images/user/avatar-4.jpg"
                                                alt="user-image" class="user-avtar">
                                        </div>
                                        <div class="flex-grow-1 ms-1">
                        ...
                        <div class="dropdown-menu dropdown-user-profile dropdown-menu-end pc-h-dropdown">
                            ...
                            <div class="tab-content" id="mysrpTabContent">
                                <div class="tab-pane fade show active" id="drp-tab-1" role="tabpanel"
                                    ...
                                    <a href="<?= _WEB_ROOT ?>/dang-xuat" class="dropdown-item">
